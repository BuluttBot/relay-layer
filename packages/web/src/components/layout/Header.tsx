  ...
  return (
    <header className="h-14 border-b border-border-subtle bg-bg-secondary flex items-center px-2 md:px-4 gap-2 md:gap-4 shrink-0">
      ...
      <div className="flex md:hidden items-center gap-1">
        ...
        <button onClick={() => toggle('agentsSidebarOpen')} className="p-2 rounded-lg hover:bg-bg-tertiary text-text-secondary hover:text-accent-teal transition-fast min-h-[44px] min-w-[44px] flex items-center justify-center" title="Agents">
          <Users size={18} />
        </button>
      </div>
    </header>
